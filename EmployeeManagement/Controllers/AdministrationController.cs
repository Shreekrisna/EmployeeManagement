...
namespace EmployeeManagement.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            else
            {
                ...
                catch(DbUpdateException ex)
                {
                    ...
                    ViewBag.ErrorMessage = $"{role.Name} role cannot be deleted as there are users in this role.Please delete the users from the role and try to delete it(role).";
                    return View("Error");
                }
            }
        }
        ...
        public async Task<IActionResult> EditUsersInRole(string roleId)
        {
            ...
            foreach (var user in _userManager.Users)
            {
                var userRoleViemodel = new UserRoleViewModel
                {
                    UserId = user.Id,
                    UserName = user.UserName,
                };
                ...
                if (await _userManager.IsInRoleAsync(user, role.Name))
                {
                    userRoleViemodel.IsSelected = true;
                }
                else
                {
                    userRoleViemodel.IsSelected = false;

                }
                model.Add(userRoleViemodel);
            }
            return View(model);
        }
